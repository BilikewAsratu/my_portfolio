...
const About = () => {
  return (
    <section id="about" className="py-24 px-4 max-w-6xl mx-auto">
      ...
      >
        <div className="relative mx-auto w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden border-2 border-[var(--color-border)]">
          <img
            src="/your-photo.jpg"
            alt="Your Name"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-bg)] to-transparent opacity-30" />
        </div>
        ...
        <div>
          ...
          <div className="mt-8 flex gap-4">
            <a
              href="/resume.pdf"
              download
              className="px-5 py-2.5 bg-[var(--color-bg-secondary)] hover:bg-[var(--color-accent)] rounded-full text-sm font-medium transition-colors text-[var(--color-text)]"
            >
              Download Resume
            </a>
          </div>
